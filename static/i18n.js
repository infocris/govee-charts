...
(() => {
  ...
  const CATALOGS = {
    en: {
      ...
      "map.section.title": "Open-room cross-section",
      "map.topology.title": "Apartment topology",
      "map.plan.topologyPreview": "Topology preview",
      "map.plan.topologyEmpty": "Assign room ids to see the topology graph.",
      ...
      "map.plan.snap": "Snap",
      "map.plan.toolSelect": "Select",
      "map.plan.toolRoom": "Draw room",
      "map.plan.toolWall": "Draw wall",
      "map.plan.toolOpening": "Draw opening",
      "map.plan.toolDelete": "Delete selection",
      "map.plan.close": "Close",
      "map.plan.closeDirty": "Discard unsaved changes and close?",
    ...
    fr: {
      ...
      "map.section.title": "Coupe pièces ouvertes",
      "map.topology.title": "Topologie de l’appartement",
      "map.plan.topologyPreview": "Aperçu topologie",
      "map.plan.topologyEmpty": "Attribuez des pièces pour voir le graphe de topologie.",
      ...
      "map.plan.toolSelect": "Sélection",
      "map.plan.toolRoom": "Dessiner une pièce",
      "map.plan.toolWall": "Dessiner un mur",
      "map.plan.toolOpening": "Dessiner une ouverture",
      "map.plan.toolDelete": "Supprimer la sélection",
      "map.plan.close": "Fermer",
      "map.plan.closeDirty": "Abandonner les modifications non enregistrées et fermer ?",
